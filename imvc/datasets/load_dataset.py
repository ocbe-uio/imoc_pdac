...
class LoadDataset:
    ...
    def load_pdac(return_y: bool = False, return_metadata: bool = False):
        r"""
        The dataset comprises multi-omic data from PDAC patients, extracted from the TCGA website. There are five types
        of omics data available: RPPA, miRNA, RNAseq, methylation and mutations. We are starting off trying to obtain
        two clusters for simplicity.

        Samples: 90; Views: 5; Features: [192, 553, 1565, 2187, 71]; Clusters: 2
