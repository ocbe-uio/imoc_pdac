...
class RunClustering:
    ...
    @staticmethod
    def run_iteration(idx, results, Xs, n_clusters, algorithms, incomplete_algorithms,
        ...
        try:
            ...
            dataset_name, view_combinations, alg_name, p, amputation_mechanism, impute, run_n, cluster_num = (
                ...
                row_index.get_level_values("n_clusters")[0])
    ...
    @staticmethod
    def save_record(train_Xs, train_X, y_pred, elapsed_time, random_state, errors_dict):
